<?php
    class doctorModel {
        ...
        public function addDoctor($dfirstname, $dlastname, $ddateofbirth, $demail, $dcontactnumber, $dintro, $dmedicalcenter, $dareaofspec, $dpicurl) {
          
            $newdoctor = "INSERT INTO doctor(firstName, lastName, dateOfBirth, email, contactNumber, intro, medicalCenter, areaOfSpec, picUrl) VALUES (:dfirstname, :dlastname, :ddateofbirth, :demail, :dcontactnumber,:dintro, :dmedicalcenter, :dareaofspec, :dpicurl)";
